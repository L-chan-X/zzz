...
if($spermission[0] >= 2){
  ...
  $sql = "INSERT INTO `mysql` (`id`, `name`, `account`, `password`, `permission`) VALUES (NULL, '".$name."', '".$account."', '".$password."', '".$cpermission."');";
  $db->query($sql);
  gourl("新增使用者成功", "backstage.php");
} else
  gourl("權限不足！", "backstage.php");
?>