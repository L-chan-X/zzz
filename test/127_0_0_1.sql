...
-- 資料庫： `jnjs`
--
CREATE DATABASE IF NOT EXISTS `jnjs` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `jnjs`;
...
INSERT INTO `jnjs` (`id`, `name`, `account`, `password`, `permission`) VALUES
(00000, '管理員', 'admin', '1234', 3),
(00001, '', 'admin', '1234', 2),
(00002, '', 'root', '3CgCKnaEq7m6mEY', 2),
(00003, '', 'root', '3CgCKnaEq7m6mEY', 1);
...
('root', '[{\"db\":\"jnjs\",\"table\":\"jnjs\"},{\"db\":\"JNJS\",\"table\":\"jnjs\"}]');
...
('root', '2019-02-15 11:49:37', '{\"lang\":\"zh_TW\",\"Console\\/Mode\":\"show\",\"Console\\/Height\":168}');
